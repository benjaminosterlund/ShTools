# Script to browse table data using PSMenu for table selection
param(
...
try {
    ...
    Write-Host "`nFound $($tableNames.Count) tables in the database." -ForegroundColor Green
...
Write-Host "Browse Table Data script completed." -ForegroundColor Green